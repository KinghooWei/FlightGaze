...
Java_com_xwlab_blacklist_Face_FaceModelInit(JNIEnv *env, jobject instance,
...
Java_com_xwlab_blacklist_Face_FaceDetect(JNIEnv *env, jobject instance,
...
JNIEXPORT jboolean JNICALL
Java_com_xwlab_blacklist_Face_FaceModelUnInit(JNIEnv *env, jobject instance) {
    if (!detection_sdk_init_ok) {
...
Java_com_xwlab_blacklist_Face_FaceFeatureRestore(JNIEnv *env, jobject instance,
...
Java_com_xwlab_blacklist_Face_FaceRecognize(JNIEnv *env, jobject instance,
