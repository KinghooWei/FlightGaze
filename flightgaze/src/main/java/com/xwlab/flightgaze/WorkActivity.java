...
//                Logger.i(TAG, "实时检测人脸");
    ...
    private void display(Passenger passenger) {
        ...
        tvIdentifyID.setText("身份识别号：" + passenger.getPassengerId());
        tvFrom.setText("从 " + flightGazeApplication.getFrom());
        tvTo.setText("到 " + flightGazeApplication.getTo());
        tvClass.setText("舱位：" + passenger.getFlightClass());
        tvSeat.setText("座位：" + passenger.getSeat());
        tvGate.setText("登机口：" + passenger.getGate());
        if (passenger.isMask()) {
